...
function validateSaveRecords_(body, users) {
 ...
 　 if (record.careRecord !== undefined && record.careRecord !== null && typeof record.careRecord !== 'string') throw new Error('記録本文が不正です。');
　　if (String(record.careRecord || '').length > 1000) throw new Error('記録本文が長すぎます。');
